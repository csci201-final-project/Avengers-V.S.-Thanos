...
export class LoadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("time_stone", "./assets/time_stone.png");
        this.load.image("space_stone", "./assets/space_stone.png");
        this.load.image("power_stone", "./assets/power_stone.png");
        this.load.image("reality_stone", "./assets/reality_stone.png");
        this.load.image("soul_stone", "./assets/soul_stone.png");
        this.load.image("mind_stone", "./assets/mind_stone.png");
...
/*        this.load.image('logo', 'assets/zenvalogo.png');
        ...
        this.load.on('progress', function (value) {
        	var num = parseInt(value * 100-1);
        	if(num < 0)
        		num = 0;
            percentText.setText(num + '%');
            progressBar.clear();
